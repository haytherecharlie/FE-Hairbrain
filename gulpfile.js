...
gulp.task("rating-custom-sass", function() {
  gulp
    .src(["resources/sass/rating/rating.scss"])
...
gulp.task("rating-custom-js", function() {
  return gulp
    .src(["resources/js/rating/rating.js"])
    .pipe(sourcemaps.init())
...
gulp.task("map-custom-js", function() {
  return gulp
    .src(["resources/js/templates/navmenu.js", "resources/js/map/map.js"])
    .pipe(sourcemaps.init())
    .pipe(concat("map.js"))
    .pipe(gutil.env.api === "prod" ? uglify() : gutil.noop()) // uglify with '--api prod'
    .pipe(gulp.dest("./public/app/js/"));
...
gulp.task("mistake-custom-sass", function() {
  gulp
    .src(["resources/sass/learn/mistake/mistake.scss"])
...
gulp.task("mistake-custom-js", function() {
  return gulp
    .src(["resources/js/learn/mistake/mistake.js"])
    .pipe(sourcemaps.init())
...
gulp.task("privacy-custom-sass", function() {
  gulp
    .src(["resources/sass/learn/privacy/privacy.scss"])
...
gulp.task("terms-custom-sass", function() {
  gulp
    .src(["resources/sass/learn/terms/terms.scss"])
...
gulp.task("schedulr-custom-sass", function() {
  gulp
    .src(["resources/sass/templates/schedulr.scss"])
...
gulp.task("schedulr-custom-js", function() {
  return gulp
    .src(["resources/js/templates/schedulr.js"])
    .pipe(sourcemaps.init())
...
gulp.task("vendor-js", function() {
  return gulp
    .src([
      ...
      "resources/js/universal/api/" +
        (gutil.env.api ? gutil.env.api : "test") +
        "api.js"
    ])
    .pipe(sourcemaps.init())
...
gulp.task("watch", function() {
  gulp.watch(["resources/js/**/*.js", "resources/sass/**/*.scss"], ["default"]);
});
